...
var require_index_001 = __commonJS({
  "assets/index-5tsPLHWp.js"(exports, module) {
    (function polyfill() {
    ...
    (function(V, p) {
      ...
      function U(e) {
        ...
        if (e.load && e.load.remembered ? d.each(e.load.remembered, function(S, T) {
          N(e, T, T === e.preset);
        }) : N(e, I, false), l.bind(h, "change", function() {
      ...
      var Me = Array.prototype.forEach, me = Array.prototype.slice, d = { BREAK: {}, extend: function(e) {
        ...
        return d.each($e, function(t) {
          if (t.litmus(e))
            return d.each(t.conversions, function(i, n) {
              if (_e = i.read(e), Te === false && _e !== false)
        ...
        function e() {
          if (M(this, e), this.__state = we.apply(this, arguments), this.__state === false)
      ...
      var J = /(\d+(\.\d+)?)px/, l = { makeSelectable: function(e, t) {
        ...
        var n = i, u = t;
        d.isUndefined(u) && (u = true), d.isUndefined(n) && (n = true), e.style.position = "absolute", u && (e.style.left = 0, e.style.right = 0), n && (e.style.top = 0, e.style.bottom = 0);
        ...
        function t(i, n, u, c, h) {
          function g(R) {
            ...
            return m.setValue(r(R.clientX, q.left, q.right, m.__min, m.__max)), false;
          }
          function b() {
        ...
        function t(i, n) {
          ...
          function b() {
            var F = we(this.value);
            F !== false ? (R.__color.__state = F, R.setValue(R.__color.toOriginal())) : this.value = R.__color.toString();
          }
          function v() {
          ...
          function S(F) {
            ...
            return fe > 1 ? fe = 1 : fe < 0 && (fe = 0), be > 1 ? be = 1 : be < 0 && (be = 0), R.__color.v = fe, R.__color.s = be, R.setValue(R.__color.toOriginal()), false;
          }
          function T(F) {
            F.type.indexOf("touch") === -1 && F.preventDefault();
...
`);
      ...
      var I = "Default", re = function() {
        ...
        var i = this, n = t || {};
        this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), l.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], n = d.defaults(n, { closeOnTop: false, autoPlace: true, width: e.DEFAULT_WIDTH }), n = d.defaults(n, { resizable: n.autoPlace, hideable: n.autoPlace }), d.isUndefined(n.load) ? n.load = { preset: I } : n.preset && (n.load.preset = n.preset), d.isUndefined(n.parent) && n.hideable && j.push(this), n.resizable = d.isUndefined(n.parent) && n.resizable, n.autoPlace && d.isUndefined(n.scrollable) && (n.scrollable = true);
        ...
        if (Object.defineProperties(this, { parent: { get: function() {
          ...
          if (n.closed = false, l.addClass(this.domElement, e.CLASS_MAIN), l.makeSelectable(this.domElement, false), re && u) {
          ...
          }), n.closed || (this.closed = false);
        }
        n.autoPlace && (d.isUndefined(n.parent) && (ne && (Y = document.createElement("div"), l.addClass(Y, "dg"), l.addClass(Y, e.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(Y), ne = false), Y.appendChild(this.domElement), l.addClass(this.domElement, e.CLASS_AUTO_PLACE)), this.parent || Le(i, n.width)), this.__resizeHandler = function() {
          i.onResizeDebounced();
      ...
      C.toggleHide = function() {
        ...
        d.each(this.__folders, function(t) {
          e.removeFolder(t);
        }), l.unbind(window, "keydown", C._keydownHandler, false), Ue(this);
  ...
  <div id="dg-save-locally">
    ...
    <div id="dg-local-explain">The values saved to <code>localStorage</code> will
      ...
      and your friends may not see the same values you do.
        ...
        this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = Ee(this), Oe(this, false), this.saveToLocalStorageIfPossible();
      }, saveAs: function(e) {
        this.load.remembered || (this.load.remembered = {}, this.load.remembered[I] = Ee(this, true)), this.load.remembered[e] = Ee(this), this.preset = e, N(this, e, true), this.saveToLocalStorageIfPossible();
      }, revert: function(e) {
      ...
      V.color = Ge, V.controllers = Xe, V.dom = H, V.gui = De, V.GUI = Ve, V.default = Ye, Object.defineProperty(V, "__esModule", { value: true });
    });
    ...
    window["webgl-fluid"].default(getElementById("loader"), {
      IMMEDIATE: false,
      SIM_RESOLUTION: 128,
      DYE_RESOLUTION: 1024,
    ...
    function createRenderer() {
      ...
      renderer2.domElement.id = "solarCanvas";
      document.body.appendChild(renderer2.domElement);
      renderer2.gammaOutput = false;
      return renderer2;
    }
    ...
    function createCamera() {
      const camera2 = new PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 5e3);
      camera2.position.set(-1e3, 800, 300);
      return camera2;
    }
    function createCubeLoader(scene2) {
      const cubeTextureLoader = new CubeTextureLoader();
      scene2.background = cubeTextureLoader.load([
        texturePaths.stars,
        texturePaths.stars,
        texturePaths.stars,
        texturePaths.stars,
    ...
    function ambient(scene2) {
      const ambient2 = new AmbientLight(16777215, 0.5);
      scene2.add(ambient2);
    }
    function pointLight(sun) {
      const pointLight2 = new PointLight(16777215, 2e3, 500);
      sun.add(pointLight2);
    }
    const jsonFilePath$1 = "/data/planetsDataEn.json";
    async function fetchPlanetNames() {
      try {
        const response = await fetch(jsonFilePath$1);
    ...
    function focusPlanet(planetName) {
      ...
      const offset = new Vector3(0, distance, distance);
    ...
    function randomLetters(element, originalText) {
      const letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
      let iterations = 0;
      const interval = setInterval(() => {
        element.textContent = element.textContent.split("").map((_, index) => {
          if (index < iterations) {
    ...
    async function fetchPlanetKeys(planetName) {
      try {
        if (!planetName) {
      ...
      buttonsContainer.addEventListener("click", async (event) => {
        ...
        if (targetButton) {
          ...
          if (isSelected) {
            ...
            createHUD(planetKeys);
          } else {
            orbitAnimationState.value = true;
            camera.position.set(-1e3, 1e3, 300);
    ...
    function createPlanet(size, texturePath, position, ring, isSun = true) {
      ...
      const orbitPoints = orbit2.getPoints(200);
    ...
    function createAllPlanets() {
      return {
        ...
        mercury: createPlanet(1, texturePaths.mercury, 81.88, null, false),
        ...
        uranus: createPlanet(10.4, texturePaths.uranus, 658.02, null, false),
    ...
    function animateRotation() {
      ...
      planets.sun.planet.rotateY(1e-3 * (coefficientEarthRotation / 0.2));
    ...
    const orbit = initOrbitControls();
    const planets = createAllPlanets();
    let orbitAnimationState = { value: true };
...
//# sourceMappingURL=index-5tsPLHWp.js.map
